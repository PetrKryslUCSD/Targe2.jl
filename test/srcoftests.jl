...
# t10
input="""
! Triangle with a triangular hole
...
# t102
input="""
! Square with a circular hole with a circular fill
! Almost touching curves, strongly stretched triangles
!
...
# t103
input="""
! Square with nested circles, two domains
curve 1 line -1 -1 -0.7 -1
curve 2 line -0.7 -1 -0.7 -0.7
curve 3 line -0.7 -0.7 -1 -0.7
curve 4 line -1 -0.7 -1 -1
...
input="""
!
!  Ementaler cheese: Locally refined mesh
!
...
# t11
input="""
! triangle with a triangular nested domain
curve 1 line 0 , -1 5,7
curve 2 line 5,7 -2,8
curve 3 line 0 , -1 -2,8
curve 4 line 0,2 2,4.2
...
# t110
input="""
! "Abstract art" With uniform mesh
...
# t111
input="""
! ==+MAP: 5 NESTED SUBREGIONS, FIXED LINES AND POINTS
m-ctl-point constant 10
...
# t112
input="""
! "Abstract art" with very coarse mesh
...
# t12
input="""
! Triangle with a triangular hole, Graded mesh
curve 1 line 0 , -1 5,7
curve 2 line 5,7 -2,8
curve 3 line 0 , -1 -2,8
curve 4 line 0,2 2,4.2
...
# t15
input="""
! Triangle with the triangular hole, Graded mesh
curve 1 line 0 , -1 5,7
curve 2 line 5,7 -2,8
curve 3 line 0 , -1 -2,8
curve 4 line 0,2 2,4.2
...
# t16
input="""
! Triangle with the triangular hole, Graded mesh around two points
curve 1 line 0 , -1 5,7
curve 2 line 5,7 -2,8
curve 3 line 0 , -1 -2,8
curve 4 line 0,2 2,4.2
...
# t17
input="""
! Triangle with the triangular hole, Graded mesh at the bottom
curve 1 line 0 , -1 5,7
curve 2 line 5,7 -2,8
curve 3 line 0 , -1 -2,8
curve 4 line 0,2 2,4.2
...
# t18
input="""
! Triangle with the triangular hole, uniform mesh
curve 1 line 0 , -1 5,7
curve 2 line 5,7 -2,8
curve 3 line 0 , -1 -2,8
curve 4 line 0,2 2,4.2
...
# t19
input="""
!     Polygonal region, with one subregion
...
# t2
input="""
! Triangle with refinement in the middle
...
# t22
input="""
! Square with the diagonal slot, refinement around the tips
...
# t31
input="""
! graded mesh on a triangle, Gradation to points inside the triangle
!
curve 1 line 0 -1 3 1.5 
curve 2 line 3 1.5  -2 2
curve 3 line 0 -1 -2 2  
...
# t35
input="""
! graded mesh on a triangle, Gradation to two point
!
curve 1 line 0 -1 3 1.5 
curve 2 line 3 1.5  -2 2
curve 3 line 0 -1 -2 2  
...
# t39
input="""
! graded mesh on a triangle, Tiny nested circle
!
curve 1 line 0 -1 3 1.5 
curve 2 line 3 1.5  -2 2
curve 3 line 0 -1 -2 2  
...
# t40
input="""
! graded mesh on a triangle, Tiny nested circular domain
!
...
# t43
input="""
! ==+GRADED ON A TRIANGLE - strongly graded AROUND CORNERS
...
input="""
!
! square with a very strong gradation at all corners (1:200,000)
!
curve 1 line -100 -100 100 -100
curve 2 line 100 -100 100 100
curve 3 line 100 100 -100 100
...
input="""
!
! square with a extreme gradation at two corners (1:500,000)
!
curve 1 line -100 -100 100 -100
curve 2 line 100 -100 100 100
curve 3 line 100 100 -100 100
...
# t53
input="""
! ==+L-shaped quarter of a plate, uniform 
...
input="""
!
! curved-side triangle, Spiky corners
!
curve 1 line 0 3 -3 0  
...
input="""
!
! curved-side triangle, Teardrop shape
!
curve 1 line 0 3 -3 0  
...
# t64
input="""
! quarter of the plate with hole
...
# t65
input="""
! quarter of the plate with the hole
curve 11 LINE [3.300000,6.040000] [0.000000,6.040000] GID 766178277,
curve 13 LINE [0.000000,6.040000] [0.000000,4.53000] GID 766178340,
curve 14 LINE [0.000000,4.53000] [0.000000,3.02000] GID 766178343,
curve 15 LINE [0.000000,3.02000] [0.000000,1.51000] GID 766178344,
...
# t67
input="""
! Quarter of the plate with a circular hole, with Discretized curves
...
# t69
input="""
! L- shaped domain with extremely large elements
m-ctl constant 2
...
input="""
!
! curved-side triangle, Three circular arc sides
!
...
# t75
input="""
! Domain with circular arcs and Discretized curves, Very coarse mesh
...
input="""
!
! curved-side triangle And circular hole
!
curve 1 line 0 3 -3 0  
curve 2 arc 3 0 -3 0 center 0.1 3
curve 3 line 3 0 0 3
...
# t8
input="""
! Shear wall with refinement of the legs
...
# t80
input="""
! triangle  With gradation of the bottom
...
input="""
!
! full circle with steep gradation at the boundary, Refinement defined with triangles
!
...
# t86
input="""
! Test continuation of input lines
m-ctl constant 1.
...
# t87
input="""
! Rectangle with a triangular hole
m-ctl constant 1
...
input="""
!
! square with a very strong gradation at the midpoints of edges
!
curve 1 line -100 -100 100 -100
curve 2 line 100 -100 100 100
curve 3 line 100 100 -100 100
